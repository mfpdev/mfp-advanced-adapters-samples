 ...
 * This is different from setting the parameter in [WLGeoAcquisitionPolicy setMinChangeDistance:] as other triggers may still activate
 ...
 * The value should be greater than that of the parameter set in [WLGeoAcquisitionPolicy setMinChangeDistance:], otherwise it will have no effect.
