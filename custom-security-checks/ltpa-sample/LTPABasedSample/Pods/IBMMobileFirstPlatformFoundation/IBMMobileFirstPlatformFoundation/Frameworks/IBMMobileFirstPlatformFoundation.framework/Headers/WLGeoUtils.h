...
/**
	 ...
	 * getDistanceToCircle(WLCoordinate, WLCircle, double)with a <code>0</code> as the <code>bufferZoneWidth</code> parameter.
	 * 
...
/**
	 ...
	 * Equivalent to calling isInsideCircle(WLCoordinate, WLCircle, double, WLConfidenceLevel)
	 * with a <code>bufferZoneWidth</code> of <code>0</code> and a <code>confidenceLevel</code> of WLConfidenceLevel.LOW.
	 * 
	 * @param coordinate The coordinate
	 * @param circle The circle
...
/**
      ...
      * Equivalent to calling isOutsideCircle(WLCoordinate, WLCircle, double, WLConfidenceLevel)}
      * with a <code>bufferZoneWidth</code> of <code>0</code> and a <code>confidenceLevel</code> of WLConfidenceLevel.LOW.
      * 
      * @param coordinate The coordinate
      * @param circle The circle
...
/**
	 * Calculates the distance of a coordinate from a polygon. Equivalent to calling
      * getDistanceToPolygon::: with a <code>0</code> as the <code>bufferZoneWidth</code> parameter.
	 * 
	 * @param coordinate The coordinate
...
/**
      ...
      * Equivalent to calling isInsidePolygon(WLCoordinate, WLPolygon, double, WLConfidenceLevel)
      * with a <code>bufferZoneWidth</code> of <code>0</code> and a <code>confidenceLevel</code> of WLConfidenceLevel.LOW.
      * 
      * @param coordinate The coordinate
      * @param polygon The polygon
...
/**
      ...
      * Equivalent to calling isOutsidePolygon(WLCoordinate, WLPolygon, double, WLConfidenceLevel)
      * with a <code>bufferZoneWidth</code> of <code>0</code> and a <code>confidenceLevel</code> of WLConfidenceLevel.LOW.
      * 
      * @param coordinate The coordinate
      * @param polygon The polygon
...
/**
      ...
      * Equivalent to calling isInsideArea(WLCoordinate, WLArea, double, WLConfidenceLevel)
      * with a <code>bufferZoneWidth</code> of <code>0</code> and a <code>confidenceLevel</code> of WLConfidenceLevel.LOW.
	 * 
	 * @param coordinate The coordinate
	 * @param area The area
...
/**
      ...
      * Equivalent to calling isOutsideArea(WLCoordinate, WLArea)
      * with a <code>bufferZoneWidth</code> of <code>0</code> and a <code>confidenceLevel</code> of WLConfidenceLevel.LOW.
	 * 
	 * @param coordinate The coordinate
	 * @param area The area
...
/**
      ...
      * getDistanceToArea(WLCoordinate, WLArea, double) with a <code>0</code> as the <code>bufferZoneWidth</code> parameter.
	 * 
	 * @param coordinate The coordinate
	 * @param area The area
